...
Use the TCP protocol. this is the default.  It may be useful (see Tunnel Mode)
to specify this option after for example the UDP option in order to allow a
cross-tunneling between TCP and UDP.
...
Answers the telnet codes as described in the RFC 0854.  With this option, the
...
Originally written by Giovanni Giacobbi E<lt>johnny@themnemonic.orgE<gt>.
